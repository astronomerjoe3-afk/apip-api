...
def vault_house_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Explains how nucleus, electrons, protons, and neutrons fit together."), representation("diagram", "Shows the Core Vault and Orbit Ring as different parts of one atom."), representation("notation", "Introduces atomic number and mass number language.")],
...
def isotope_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Defines isotopes with proton and neutron language."), representation("diagram", "Shows same-badge vaults side by side."), representation("table", "Compares atomic number, mass number, and neutron number."), representation("notation", "Uses A, Z, and N to classify nuclei.")],
            ...
            mastery_skills=["identify_isotopes", "atomic_number", "neutron_count", "radioisotope"],
...
def half_life_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            mastery_skills=["define_half_life", "random_decay", "half_life_fraction", "half_life_number"],
...
def background_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Explains why background radiation is normal."), representation("diagram", "Shows a detector surrounded by environmental sources."), representation("table", "Separates measured, background, and corrected count rates."), representation("calculation", "Uses subtraction to find the source-only rate.")],
            ...
            mastery_skills=["background_sources", "background_variation", "background_subtraction"],
