...
M13_MODULE_ID = "M13"
M13_CONTENT_VERSION = "20260321_m13_core_vault_v3"
...
def half_life_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            visual_assets=[visual("m13-l4-half-life-curve", "settle_span", "Settle Span Arena", "Shows the radioactive sample curving downward by halves over equal intervals rather than dropping by the same number each time.", "The equal-interval and half-remaining labels must stay easy to compare.", template="physics_graph", meta={"graph_type": "generic_xy", "title": "Settle Span Arena", "subtitle": "Equal intervals halve what remains, so the decay pattern curves instead of falling linearly.", "x_label": "Time (half-life intervals)", "y_label": "Undecayed nuclei", "show_legend": False, "x_min": 0, "x_max": 4, "y_min": 0, "y_max": 100, "series": [{"label": "Undecayed sample", "points": [[0, 80], [1, 40], [2, 20], [3, 10], [4, 5]], "color": "#38bdf8"}], "annotations": [{"x": 1.0, "y": 43.0, "text": "1/2 remains", "color": "#fde68a"}, {"x": 2.0, "y": 22.5, "text": "1/4 remains", "color": "#bbf7d0"}, {"x": 3.0, "y": 12.0, "text": "1/8 remains", "color": "#fda4af"}]})],
...
_sync_assessed_skills(M13_LESSONS)
