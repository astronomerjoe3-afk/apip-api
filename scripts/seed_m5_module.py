...
def lesson_l1() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            mcq("M5L1_D1", "What is the weakest statement about heating matter?", ["particles move more", "particles can end up a little further apart", "particles themselves get bigger", "the state can change if the balance changes enough"], 2, "Particle size is not the thing that changes.", ["particle_size_heating_confusion"], skill_tags=["particle_size_rule"]),
            mcq("M5L1_D2", "Which idea belongs to the whole material rather than one particle?", ["a particle is wet", "a particle is hard", "a particle has mass", "a particle is blue because the liquid is blue"], 1, "Bulk hardness is not a one-particle property.", ["particle_bulk_property_confusion"], skill_tags=["bulk_vs_particle"]),
            ...
            mcq("M5L1_D6", "Which statement about a liquid is wrong?", ["its particles are close together", "its particles can change neighbors", "its particles are almost as far apart as in a gas", "its particles still move randomly"], 2, "Liquids are not half-gases with huge gaps.", ["liquid_spacing_confusion"], skill_tags=["liquid_spacing"]),
        ...
        "contract": contract(
            ...
            worked_examples=[
                ...
                worked("A learner says one water particle is wet. What is the stronger statement?", ["Separate one particle from the whole material first.", "Treat wetness as a bulk outcome of many particles interacting.", "State what a single particle can still have, such as mass and motion."], "Wetness belongs to the bulk material, not to one isolated particle.", "Bulk properties emerge from many particles together, while one particle is just one tiny unit of matter.", "This keeps single-particle language from copying whole-material properties blindly."),
...
def lesson_l2() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            ...
            mcq("M5L2_D2", "Which sentence about a liquid is wrong?", ["Particles are close together", "Particles can change neighbors", "Particles are almost as far apart as in a gas", "Particles still move randomly"], 2, "Liquids stay close-packed.", ["liquid_spacing_confusion"], skill_tags=["liquid_spacing"]),
...
def lesson_l3() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            ...
            mcq("M5L3_D2", "Which statement about Brownian motion is wrong?", ["It is a visible zigzag motion", "It is caused by collisions with surrounding molecules", "It proves the visible particle is self-propelled", "It is random rather than a steady one-way motion"], 2, "The visible particle is not powering itself.", ["brownian_self_motion_confusion"], skill_tags=["brownian_cause"]),
...
def lesson_l5() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            ...
            mcq("M5L5_D2", "Which statement is wrong?", ["Internal energy includes kinetic energy", "Internal energy includes potential energy", "Internal energy must be equal whenever temperature is equal", "Internal energy is a whole-system total"], 2, "Same temperature does not force equal total internal energy.", ["same_temperature_same_internal_energy_confusion"], skill_tags=["temp_vs_store"]),
...
def lesson_l6() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            mcq("M5L6_D1", "Which statement about adding energy is weakest?", ["It can raise temperature", "It can increase internal energy during a state change", "It must always raise temperature sharply", "It can loosen particle links"], 2, "That is the misconception this lesson is targeting.", ["state_change_energy_confusion"], skill_tags=["state_change_links"]),
