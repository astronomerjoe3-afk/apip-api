...
def lesson_l4() -> Dict[str, Any]:
    return {
        ...
        "transfer": [
            ...
            short("M4L4_M5", "A water patch at 3 m depth has pressure p. Another water patch at the same depth in a different-shaped container has what pressure?", ["the same pressure", "same pressure", "p"], "Equal depth in the same liquid gives equal pressure.", ["same_depth_shape_confusion"], acceptance_rules=acceptance_groups(["same", "equal", "match", "unchanged", "p"], ["pressure", "reading", "meter"])),
...
def lesson_l6() -> Dict[str, Any]:
    return {
        ...
        "transfer": [
            ...
            short("M4L6_M2", "At depth 3 m in water, with p_atm = 100000 Pa, what is the total pressure if ρ = 1000 kg/m^3 and g = 10 N/kg?", ["130000 Pa", "130000"], "Use p_total = p_atm + ρgh.", ["total_pressure_confusion"], acceptance_rules=acceptance_groups(["130000"])),
