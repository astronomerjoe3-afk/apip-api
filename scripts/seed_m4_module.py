...
def lesson_l3() -> Dict[str, Any]:
    return {
        ...
        "diagnostic": [
            ...
            short("M4L3_D5", "What three factors set liquid pressure in p = rhogh?", ["density, gravitational field strength, and depth", "rho g and h", "liquid density, world pull, and depth"], "Name density, g, and depth.", ["liquid_density_confusion"], acceptance_rules=acceptance_groups(["density", "rho"], ["g", "world pull", "gravitational", "gravity", "field strength"], ["depth", "height", "h", "below the surface"])),
