...
def lesson_l1() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l1-travel-pattern", "travel_pattern", "Traveling pattern, local pads", "Shows one front crossing a line of pads while each pad only moves around its own position.", "The pattern travels across the stadium, while each pad only pulses locally.")],
...
def lesson_l2() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l2-mode-match", "wave_type", "Cross-Sway and Push-Squeeze", "Shows the same travel direction with two different local-motion rules.", "Wave style depends on the relation between local motion and travel direction.")],
...
def lesson_l3() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l3-vflambda", "wave_equation", "Beat Rate, Pulse Gap, and Ripple Run", "Shows launch rate, front spacing, and front speed on one board.", "Wave speed comes from the product of frequency and wavelength.")],
...
def lesson_l4() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l4-bounce-wall", "reflection", "Bounce Wall reflection", "Shows a front hitting a flat wall with the normal line and equal reflected geometry.", "Reflection is a boundary bounce measured from the normal.")],
...
def lesson_l5() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l5-pace-zone", "refraction", "Pace Zone turn", "Shows one front entering a slower and faster zone with direction change, speed change, and wavelength change.", "Refraction is a turn caused by a speed change in a new medium.")],
...
def lesson_l6() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract_payload=contract(
            ...
            visual_assets=[visual("m7-l6-gate-spread", "diffraction", "Gate Spread comparison", "Shows a wide gate and a narrow gate with different spread patterns plus an edge case.", "Diffraction is strongest when the opening size is comparable to the wavelength.")],
