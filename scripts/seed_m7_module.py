...
def lesson_l1() -> Dict[str, Any]:
    ...
    concept = [
        short("M7L1_C1", "Why is a wave not the same thing as the pads moving across the field?", ["The disturbance travels while the pads only oscillate locally.", "The pattern moves across the medium, but the medium stays near its own place."], "Separate travel of the pattern from motion of the medium.", ["medium_moves_with_wave_confusion"], acceptance_rules=acceptance_groups(["pattern", "disturbance", "wave"], ["travels", "moves across"], ["pad", "medium"], ["local", "in place", "oscillate"]), skill_tags=["pattern_vs_medium"]),
        ...
        short("M7L1_C4", "How can a wave carry energy if the medium is not carried all the way across?", ["The disturbance transfers energy from one part of the medium to the next while each part only moves locally.", "Energy passes along the pattern even though the material itself mainly oscillates in place."], "Focus on disturbance transfer, not medium travel.", ["energy_disturbance_confusion"], acceptance_rules=acceptance_groups(["energy"], ["transfer", "passes", "moves along"], ["pattern", "disturbance"], ["medium", "material", "pads"], ["local", "in place", "oscillate"]), skill_tags=["energy_transfer"]),
    ...
    transfer = [
        ...
        short("M7L1_M3", "In a stadium wave, what travels even though each person only stands and sits locally?", ["The disturbance pattern travels around the stadium while the people stay in their own places.", "The wave moves around the stadium, not the people."], "State what travels and what stays local.", ["medium_moves_with_wave_confusion"], acceptance_rules=acceptance_groups(["pattern", "disturbance", "wave"], ["travels", "moves around"], ["not", "rather than", "stay", "stays", "stand", "stands", "sit", "sits", "local", "in place"], ["people", "pads", "medium"]), skill_tags=["pattern_vs_medium"]),
        ...
        short("M7L1_M6", "Why can two pads 4 m apart still belong to the same Front Line?", ["A front line joins points that are in the same phase even at different positions.", "Those pads can be at the same stage of the pattern at the same time."], "Use same-phase language.", ["front_line_phase_confusion"], acceptance_rules=acceptance_groups(["same", "matching"], ["phase", "stage"], ["front line", "wavefront"]), skill_tags=["phase_front"]),
        ...
        short("M7L1_M8", "Why is the sentence 'the pads move across the arena' a weak wave description?", ["The disturbance pattern crosses the arena while each pad only pulses locally.", "The wave travels across the arena, but the pads stay near their own places."], "The wave is the travel pattern, not the medium drifting across.", ["medium_moves_with_wave_confusion"], acceptance_rules=acceptance_groups(["pad", "medium"], ["local", "oscillate", "pulse"], ["pattern", "disturbance", "wave"], ["crosses", "travels across"]), skill_tags=["pattern_vs_medium"]),
    ]
    return lesson_spec(
        lesson_id="M7_L1",
...
_sync_assessed_skills(M7_LESSONS)
