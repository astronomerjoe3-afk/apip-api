...
M9_MODULE_ID = "M9"
M9_CONTENT_VERSION = "20260321_m9_echo_scout_v1"
...
def sound_launch_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            visual_assets=[visual("m9-l1-beacon-launch", "sound_source", "Beacon launch", "Shows the source vibrating and pushing on nearby air.", "The source and the first squeeze band should stay visually distinct.")],
...
def relay_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Defines compressions, rarefactions, and local motion."), representation("diagram", "Shows squeeze bands passing through a line of particles."), representation("model", "Keeps particle motion and wave travel separate.")],
            ...
            visual_assets=[visual("m9-l2-crowd-relay", "longitudinal_wave", "Crowd relay", "Shows compressions and rarefactions moving through the air crowd.", "Particle arrows and pressure bands should stay visually separate.")],
...
def pitch_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            visual_assets=[visual("m9-l3-pitch-meter", "frequency_pitch", "Pitch meter", "Shows ping rate, tone height, and separate loudness information.", "The pitch meter and the loudness bar should not be merged visually.")],
...
def ultrasound_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Classifies audible and ultrasonic sound."), representation("table", "Compares example frequencies with the Hear Zone."), representation("diagram", "Shows audible and ultrasound bands on one frequency scale.")],
            ...
            visual_assets=[visual("m9-l4-hear-zone", "ultrasound_range", "Hear Zone scale", "Shows audible and ultrasound bands on one frequency line.", "The 20 kHz boundary should remain easy to read.")],
...
def echo_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            visual_assets=[visual("m9-l5-echo-map", "echo_imaging", "Echo map", "Shows a pulse leaving the probe, reflecting from a boundary, and returning to build a depth clue.", "The outgoing pulse, returning echo, and boundary depth label should remain visually distinct.")],
...
def doppler_lesson() -> Dict[str, Any]:
    ...
    return lesson_spec(
        ...
        contract(
            ...
            representations=[representation("words", "Explains how motion changes returned frequency."), representation("diagram", "Shows approaching and receding flow relative to a probe."), representation("table", "Compares positive, negative, and zero shifts.")],
            ...
            visual_assets=[visual("m9-l6-flow-tracker", "doppler_flow", "Flow tracker", "Shows how approaching and receding flow change the returned frequency.", "The shift arrows and direction labels should stay easy to compare.")],
