...
def lesson_l2() -> Dict[str, Any]:
    return lesson_spec(
        ...
        capsule_checks=[
            ...
            short("M6L2_C5", "A 3 kg block has c = 200 J/kg degree C and receives 1200 J. What is delta T?", ["2 degree C", "2"], "Rearrange delta T = Q / (m c).", ["multi_stage_heat_calculation_confusion"], skill_tags=["heating_calculation"]),
        ...
        transfer=[
            ...
            short("M6L2_M4", "A 2 kg metal block with c = 500 J/kg degree C receives 6000 J. What temperature rise does it get?", ["6 degree C", "6"], "Use delta T = Q / (m c).", ["multi_stage_heat_calculation_confusion"], skill_tags=["heating_calculation"]),
