    ...
    if lesson_id == "M8_L1":
        ...
        lesson["transfer"].extend(
            [
                ...
                short("M8L1_M10", "Why can a screen not catch the image behind a plane mirror?", ["Because no real reflected routes meet behind the mirror; the image is only an apparent position from backward extensions.", "Because the mirror image is virtual, so a screen cannot intercept real light there."], "Tie screenability to real-route crossings.", ["real_virtual_image_confusion", "ray_diagram_literal_confusion"], skill_tags=["real_vs_virtual"], acceptance_rules=acceptance_groups(["screen"], ["cannot", "not"], ["real", "actual"], ["meet", "cross"], ["virtual", "apparent", "extension"])),
            ]
        )
        return lesson
