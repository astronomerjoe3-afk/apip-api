...
def f2_micro_prompts(doc_id: str) -> List[Dict[str, Any]]:
    prompts = {
        ...
        "F2_L6": [prompt_block("Imagine pushing an empty trolley and a loaded trolley with the same force.", "The same force changes the motion of the smaller mass more because its inertia is lower. Inertia is the resistance to changing motion.")],
    }
    ...
    (
        "f2_fma_lab",
        {
            ...
            "instructions": [
                ...
                "Use a safety example to explain why inertia, the resistance to changing motion, matters when motion changes suddenly.",
            ],
...
add_lesson(
    ...
    "Distance is like the reading on an odometer, while displacement is like the straight arrow from your starting pin to your finishing pin on a map.",
    "f2_motion_map_lab",
    [
        ...
        make_short("F2L1_D2", "A cyclist covers 180 m in 45 s. What is the average speed?", ["4 m/s"], "Use average speed = total distance / total time.", ["speed_calculation_error"]),
    ],
    [
        ...
        make_short("F2L1_T2", "A runner covers 120 m in 24 s and then 60 m in 12 s. What is the average speed for the whole trip?", ["5 m/s"], "Use total distance and total time for the whole trip, not one stage only.", ["speed_calculation_error"]),
    ],
    [
